...
def download_gg_sheet():
    ...
    # params = config()
    gc = gspread.service_account(filename="ggsheet/files/cred/gg-sheet-cred.json")
    sh = gc.open_by_url(
        "https://docs.google.com/spreadsheets/d/1yx2hG2wfmWytpxSrljE3rYrtIHD0vcm56G8bHbWn4Jg/edit#gid=266139626"
    )
    worksheet = sh.sheet1
